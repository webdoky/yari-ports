...
import noTagOmission from './macros/no_tag_omission.js';
...
import CssAnimatedProperties from './macros/css-animated-properties.js';
...
export function macros(context) {
  const macroDictionary = {
    ...
    cssanimatedproperties: CssAnimatedProperties,
  };
